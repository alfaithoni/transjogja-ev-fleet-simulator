...
\begin{center}
    ...
    {\Large\bfseries\uppercase{Simulasi Operasional Armada Bus Listrik untuk Perencanaan Infrastruktur SPKLU pada Elektrifikasi Penuh TransJogja}
}\\\vspace{4cm}
    ...
    {\large Oleh}\\[0.3cm]
    \textbf{
    {\large Muhammad Hanif Al Faithoni}\\
    {\large 18221135}
    }\\
